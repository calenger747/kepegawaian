<!--modal-->
<div class="modal fade" id="ModalAddAbout" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true ">
    <div class="modal-dialog modal-lg" role="document ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="largeModalLabel">Tambahkan Tentang Diri Anda</h5>
                ...
                <form class="form-horizontal" action="config_config_cs/about-me.php?n=file" method="post" enctype="multipart/form-data" id="tambah">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="detail" class="form-control" required="" placeholder="About Me..."></textarea>
                            </div>
                        </div>
