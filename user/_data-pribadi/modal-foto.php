    ...
    <div class="modal-dialog" role="document ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="config_config_cs/upload-foto.php?n=file" method="post" enctype="multipart/form-data" id="tambah">
                    <input type="hidden" name="id_dokumen" value="<?php echo $id_file; ?>">
                    <div class="card-body">
