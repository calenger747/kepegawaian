<!--modal-->
<div class="modal fade" id="ModalAddSkill" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true ">
    <div class="modal-dialog" role="document ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="config_config_cs/tambah-skill.php?n=file" method="post" enctype="multipart/form-data" id="tambah">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="100" name="nama_skill" type="text" required="required" class="form-control" placeholder="Skill"/>
                        </div>
                        <div class="form-group">
