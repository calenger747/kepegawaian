<!--modal-->
<div class="modal fade" id="ModalEditSkillBahasa<?php echo $a_bag['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true ">
    <div class="modal-dialog" role="document ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Kemampuan Bahasa</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true ">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" action="config_config_cs/edit-skill-bahasa.php?n=file" method="post" enctype="multipart/form-data" id="tambah">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="100" name="nama_bahasa" type="text" required="required" class="form-control" placeholder="Bahasa" value="<?php echo $a_bag['bahasa']; ?>" />
                        </div>
                        <div class="form-group">
