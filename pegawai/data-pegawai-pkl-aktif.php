            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-2">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                <a href="?view=data-pegawai-pkl-aktif&id=9973850hupa&name=pegaaplication&pegawaiPKLAktif">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Data Pegawai PKL Aktif</h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle="tooltip" title="Lihat Detail" href="?view=detail-pegawai&id=997386798hupa&name=pegaaplication&detailPegawai&nip=<?php echo $row['nik'];?>">
                                                        ...
                                                        <a href=
                                                    "config_config_cs/non-aktif-pegawai-con.php?id=<?php echo $row['nik']; ?>&hal=data-pegawai-pkl-aktif" data-toggle="tooltip" title="Non Aktifkan" onclick='/return konfirmasi("
                                                    Menghapus data <?php echo $row['nik'];?>")'><span class='fa fa-times'></span></a>
                                                    <?php    
                                                    } else { ?>
                                                        <a href=
                                                    "config_config_cs/aktif-pegawai-con.php?id=<?php echo $row['nik']; ?>&hal=data-pegawai-pkl-aktif" data-toggle="tooltip" title="Aktifkan" onclick='/return konfirmasi("
