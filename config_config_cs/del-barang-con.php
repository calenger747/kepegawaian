		...
		if(mysqli_num_rows($cek) == 0) {
			...
			if ($q_delete_barang) { ?>
				<script type="text/javascript">
					window.location="../?view=inventory-barang&mod=del&id=9973850hupa&name=pegaaplication&inventoryBarang&status=2";
		        </script>
			<?php 
			} else { ?>
				<script type="text/javascript">
				window.location="../?view=inventory-barang&mod=del&id=9973850hupa&name=pegaaplication&inventoryBarang&status=3";
	        </script>
			<?php
			}
		}
