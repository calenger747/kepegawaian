<?php
	if(isset($_GET['id']) && isset($_GET['no'])) {
		...
		$approve_peminjaman = mysqli_query($connect, "UPDATE tbl_inventory SET stat = 'PendingKembali2', user = 'ADMIN GUDANG' WHERE no_inventory='$noinven'");
		$approve_peminjaman2 = mysqli_query($connect, "UPDATE tbl_peminjaman SET stat2='5' WHERE id='$id'");
